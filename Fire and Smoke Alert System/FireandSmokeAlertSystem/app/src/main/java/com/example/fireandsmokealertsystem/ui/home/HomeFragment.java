package com.example.fireandsmokealertsystem.ui.home;
...
public class HomeFragment extends Fragment {
    ...
    private void getDeviceIDList(){
            ...
            LinearLayout new_layout_container = root.findViewById(R.id.new_layout_container);
            ...
            familyNameReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot snapshot) {
                    ...
                    for (DataSnapshot childSnapshot : snapshot.getChildren()) {
                        ...
                        TextView familyNameTextView = root.findViewById(R.id.familyName);
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(loopChanges == 0){
                            ...
                            if(numberOfLoops >= 1){
                                ...
                                LinearLayout rowLinearLayout = new LinearLayout(getActivity());
                        ...
                        if(!firstLoop){
                            ...
                            TextView electricalRoomTextview = new TextView(getActivity());
                        ...
                        if(loopChanges >= 0){
                            ...
                            LinearLayout newLayout1 = new LinearLayout(getActivity());
                            ...
                            LinearLayout sensorValueLayout = new LinearLayout(getActivity());
                            ...
                            //for smoke layout
                            LinearLayout sensorValueLayout1 = new LinearLayout(getActivity());
                            ...
                            TextView smokeTextViewIcon = new TextView(getActivity());
                            ...
                            TextView smokeTextViewText = new TextView(getActivity());
                            ...
                            LinearLayout verticalLineLayout = new LinearLayout(getActivity());
                            ...
                            //for fire layout
                            LinearLayout sensorValueLayout2 = new LinearLayout(getActivity());
                            ...
                            TextView fireTextViewIcon = new TextView(getActivity());
                            ...
                            TextView fireTextViewText = new TextView(getActivity());
