...
public class Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roomsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentRooms = new Intent(Dashboard.this, Rooms.class);
        ...
        settingsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentSettings = new Intent(Dashboard.this, Settings.class);
    ...
    private void getDeviceIDList(){
        ...
        DatabaseReference familyNameReference = FirebaseDatabase.getInstance().getReference("Home/HomeID/98801/Information");
        familyNameReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot childSnapshot : snapshot.getChildren()) {
                    Object familyName = snapshot.child("Head").child("LastName").getValue();
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(loopChanges == 0){
                            ...
                            if(numberOfLoops >= 1){
                                ...
                                LinearLayout rowLinearLayout = new LinearLayout(Dashboard.this);
                        ...
                        if(!firstLoop){
                            ...
                            LinearLayout newLayout = new LinearLayout(Dashboard.this);
                            ...
                            TextView electricalRoomTextview = new TextView(Dashboard.this);
                        ...
                        if(loopChanges >= 0){
                            ...
                            LinearLayout newLayout1 = new LinearLayout(Dashboard.this);
                            ...
                            TextView areaTextview = new TextView(Dashboard.this);
                            ...
                            LinearLayout horizontalLineLayout = new LinearLayout(Dashboard.this);
                            ...
                            LinearLayout sensorValueLayout = new LinearLayout(Dashboard.this);
                            ...
                            //for smoke layout
                            LinearLayout sensorValueLayout1 = new LinearLayout(Dashboard.this);
                            ...
                            TextView smokeTextViewIcon = new TextView(Dashboard.this);
                            ...
                            TextView smokeTextViewText = new TextView(Dashboard.this);
                            ...
                            LinearLayout verticalLineLayout = new LinearLayout(Dashboard.this);
                            ...
                            //for fire layout
                            LinearLayout sensorValueLayout2 = new LinearLayout(Dashboard.this);
                            ...
                            TextView fireTextViewIcon = new TextView(Dashboard.this);
                            ...
                            TextView fireTextViewText = new TextView(Dashboard.this);
                            ...
                            DatabaseReference appReference = FirebaseDatabase.getInstance().getReference("Home/HomeID/98801/DeviceID/" + childName.toString());
                            appReference.addChildEventListener(new ChildEventListener() {
                                ...
                                public void onChildChanged(DataSnapshot snapshot, String previousChildName) {
                                    if (snapshot.getKey().equals("Smoke")) {
                                        ...
                                        if(smokeInt > 200){
                                            Toast.makeText(Dashboard.this, "Smoke1", Toast.LENGTH_SHORT).show();
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot childSnapshot : snapshot.getChildren()) {
                            ...
                            if(loopChanges >= 0){
                                ...
                                DatabaseReference appReference = FirebaseDatabase.getInstance().getReference("Home/HomeID/98801/DeviceID/" + deviceIDString);
                                appReference.addChildEventListener(new ChildEventListener() {
                                    @Override
                                    public void onChildAdded(DataSnapshot snapshot, String previousChildName) {
                                        // Handle child added
    ...
    private void showAlertNotification(String area, String fireOrSmoke, String deviceID){
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(Dashboard.this, "channelID")
